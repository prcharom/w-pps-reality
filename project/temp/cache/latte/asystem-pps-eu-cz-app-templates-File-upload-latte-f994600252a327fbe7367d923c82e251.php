<?php
// source: /home/www/pps-eu.cz/www/asystem.pps-eu.cz/app/templates/File/upload.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6072137498', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block titulek
//
if (!function_exists($_b->blocks['titulek'][] = '_lbfc27d4ed6d_titulek')) { function _lbfc27d4ed6d_titulek($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>    Upload fotografie
<?php
}}
...
// block navigace
//
if (!function_exists($_b->blocks['navigace'][] = '_lb31b086ef3b_navigace')) { function _lb31b086ef3b_navigace($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
"><?php echo Latte\Runtime\Filters::escapeHtml($nemovitost->nazev, ENT_NOQUOTES) ?></a> » Upload PDF souborů
<?php
}}
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbd8ed575b07_content')) { function _lbd8ed575b07_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>    <div class="login"> 
<?php $_l->tmp = $_control->getComponent("uploadFileForm"); if ($_l->tmp instanceof Nette\Application\UI\IRenderable) $_l->tmp->redrawControl(NULL, FALSE); $_l->tmp->render() ?>
    </div>
<?php
}}
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb60ab3deb19_head')) { function _lb60ab3deb19_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
