<?php
// source: /home/www/pps-eu.cz/www/asystem.pps-eu.cz/app/config/config.neon 
// source: /home/www/pps-eu.cz/www/asystem.pps-eu.cz/app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			'nette\\object' => array(
				...
				'22_App_Model_Authenticator',
				'23_App_Model_Authorizator',
				'24_App_Model_Database',
				'25_App_Model_Drazba',
				'26_App_Model_Users',
				'container',
			),
			...
			'nette\\security\\iauthenticator' => array('22_App_Model_Authenticator'),
			'app\\model\\authenticator' => array('22_App_Model_Authenticator'),
			'nette\\security\\iauthorizator' => array('23_App_Model_Authorizator'),
			'app\\model\\authorizator' => array('23_App_Model_Authorizator'),
			'app\\model\\database' => array('24_App_Model_Database'),
			'app\\model\\drazba' => array('25_App_Model_Drazba'),
			'app\\model\\users' => array('26_App_Model_Users'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/home/www/pps-eu.cz/www/asystem.pps-eu.cz/app',
			'wwwDir' => '/home/www/pps-eu.cz/www/asystem.pps-eu.cz/www',
			'debugMode' => FALSE,
			'productionMode' => TRUE,
			...
			'tempDir' => '/home/www/pps-eu.cz/www/asystem.pps-eu.cz/app/../temp',
		));
	}
	 ...
	 */
	public function createService__22_App_Model_Authenticator()
	{
		$service = new App\Model\Authenticator($this->getService('nette.database.default.context'));
		return $service;
	}
	 ...
	 */
	public function createService__23_App_Model_Authorizator()
	{
	 ...
	 */
	public function createService__24_App_Model_Database()
	{
		$service = new App\Model\Database($this->getService('nette.database.default.context'));
		return $service;
	}


	/**
	 * @return App\Model\Drazba
	 */
	public function createService__25_App_Model_Drazba()
	{
		$service = new App\Model\Drazba($this->getService('nette.database.default.context'));
		return $service;
	}
	 ...
	 */
	public function createService__26_App_Model_Users()
	{
		$service = new App\Model\Users($this->getService('nette.database.default.context'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/home/www/pps-eu.cz/www/asystem.pps-eu.cz/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/home/www/pps-eu.cz/www/asystem.pps-eu.cz/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=pps-eucz01', 'pps-eucz002', 'FZLAqHu6', array('lazy' => TRUE));
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/home/www/pps-eu.cz/www/asystem.pps-eu.cz/app/../temp/cache', $this->getService('nette.cacheJournal'));
	...
	{
		$service = new Nette\Security\User($this->getService('nette.userStorage'), $this->getService('22_App_Model_Authenticator'), $this->getService('23_App_Model_Authorizator'));
		return $service;
	}
